 <template>
    <div class="flex flex-col justify-center items-center px-6 h-screen">
        <div v-if="showSuccessful" class="success-checkmark">
        ...
        <div class="w-full my-4 relative top-20">
            <nuxt-Link to="#" type="button" class="text-white w-full bg-gradient-to-r from-[#25FEB7] via-green-400 to-[#1DC7AC]
             ...
             rounded-md  p-4 text-center">Back To Homepage</nuxt-Link>
       </div>  
